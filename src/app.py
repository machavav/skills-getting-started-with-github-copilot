...
activities = {
    ...
    "Drama Club": {
        "description": "Acting, stage production, and theater workshops culminating in performances",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["henry@mergington.edu", "lucy@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for debates, improve public speaking, and compete interschool",
